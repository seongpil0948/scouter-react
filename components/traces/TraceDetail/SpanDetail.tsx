...
export const SpanDetail: React.FC<SpanDetailProps> = React.memo(
  ({ span, formatDuration, childrenCount = 0, onParentClick }) => {
    ...
    return (
      <div className="mt-4 space-y-6">
        ...
        >
          ...
          <Tab
            key="attributes"
            title={`속성 (${span.attributes ? Object.keys(span.attributes).length : 0})`}
          />
        ...
        <div className="pt-2">
                          ...
                          <tr>
                            ...
                            <td className="py-2 font-mono text-sm flex items-center">
                              ...
                              <Button
                                ...
                                isIconOnly
                                onPress={() =>
                                  copyToClipboard(span.spanId, "스팬 ID")
                                }
                              >
                                <CopyIcon size={14} />
                              </Button>
                          ...
                          <tr>
                            ...
                            <td className="py-2 font-mono text-sm flex items-center">
                              ...
                              <Button
                                ...
                                isIconOnly
                                onPress={() =>
                                  copyToClipboard(span.traceId, "트레이스 ID")
                                }
                              >
                                <CopyIcon size={14} />
                              </Button>
                              ...
                              <td className="py-2 font-mono text-sm flex items-center">
                                ...
                                <Tooltip content="부모 스팬으로 이동">
                                  <Button
                                    ...
                                    isIconOnly
                                    onPress={() =>
                                      onParentClick?.(span.parentSpanId!)
                                    }
                                  >
                                    <ServerIcon size={14} />
                                  </Button>
                    ...
                    {(() => {
                      ...
                      return (
                        <div className="grid grid-cols-1 gap-2">
                          {Object.entries(importantAttrs).map(
                            ([key, value]) => (
                              <div
                                key={key}
          ...
          {/* SQL 전용 탭 */}
          {activeTab === "sql" && (
            <SqlAttributesViewer attributes={span.attributes} />
          )}

          {/* URL 전용 탭 */}
          {activeTab === "url" && (
            <UrlAttributesViewer attributes={span.attributes} />
          )}

          {/* 모든 속성 탭 */}
          {activeTab === "attributes" && (
            <SpanAttributesViewer attributes={span.attributes} />
          )}
              ...
              <div className="relative">
                ...
                <div className="h-8 flex">
                  {[0, 25, 50, 75, 100].map((percent) => (
                    ...
                    >
                      <span className="absolute transform -translate-x-1/2 text-xs text-gray-500">
                        {percent}%
                      </span>
                    </div>
                  ))}
                  ...
                  >
                    <div
                      ...
                      style={{
                        width: "100%",
                        backgroundColor:
                          span.status === "ERROR" ? "#f87171" : "#60a5fa",
                      }}
                    />
                  </Tooltip>
                </div>
